...
public final class UpdateController {
    ...
    private static final String RELEASE_NOTES_DEV_URL = "https://github.com/ho-dev/HO/releases/download/dev/release_notes.html";
    private static final String RELEASE_NOTES_BETA_URL = "https://github.com/ho-dev/HO/releases/download/beta/release_notes.html";
    private static final String RELEASE_NOTES_STABLE_URL = "https://github.com/ho-dev/HO/releases/download/tag_stable/release_notes.html";
    ...
    public static String get_HO_zip_download_url(String full_version, String versionType) {
        ...
        return switch (versionType) {
            case "DEV" -> "https://github.com/ho-dev/HO/releases/download/dev/HO-" + full_version + "-portable-win-DEV-JRE.zip";
            case "BETA" -> "https://github.com/ho-dev/HO/releases/download/beta/HO-" + full_version + "-portable-win-BETA-JRE.zip";
            default -> "https://github.com/ho-dev/HO/releases/download/tag_stable/HO-" + full_version + "-portable-win-JRE.zip";
        };
    }
